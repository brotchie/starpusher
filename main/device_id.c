...
void device_id_initialize() {
  ...
  // on reset. Here we fully reset the pin back to being a GPIO.
...
// register (track routing was awkward if we did this), so we do
// the correct in memory for 1-8 = MSB-LSB.
